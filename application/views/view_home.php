        ...
        <main id="main">
            ...
            <section id="services">
                <div class="container" data-aos="fade-up">
                    <header class="section-header wow fadeInUp">
                        <h3>Services</h3>
                        <p>We offer a wide range of services which are not limited to the one listed below.</p>
                    </header>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="100">
                            <div class="icon"><i class="ion-ios-analytics-outline"></i></div>
                            <h4 class="title"><a href="">CES Training</a></h4>
                            <p class="description">Provides opportunities, skills and training for the entire products and systems range.</p>
                        </div>
                        <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="200">
                            <div class="icon"><i class="ion-ios-bookmarks-outline"></i></div>
                            <h4 class="title"><a href="">CES Technical</a></h4>
                            <p class="description">Provide Clients with integrated solutions across planning, operations, engineering and building products for better productivity, flexibilityand effeciency.</p>
                        </div>
                        <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="300">
                            <div class="icon"><i class="ion-ios-paper-outline"></i></div>
                            <h4 class="title"><a href="">CES Consulting</a></h4>
                            <p class="description">Work with clients to bring unique content and capacity building services to bridge standards and provide sustainable solutions for a more effecient operating environment.</p>
                        </div>
                        <!-- <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="200">
                            <div class="icon"><i class="ion-ios-speedometer-outline"></i></div>
            ...
            <section id="contact" class="section-bg">
                <div class="container" data-aos="fade-up">
                    <div class="section-header">
                        <h3>Contact Us</h3>
                        <p>For any question or inquiry regarding our services and products, you can always contact us.</p>
                    </div>
                    <div class="row contact-info">
                        ...
                        <div class="col-md-4">
                            <div class="contact-email">
                                ...
                                <p><a href="mailto:info@example.com">training@capelectrotek.co.ke</a></p>
                                <p><a href="mailto:info@example.com">technical@capelectrotek.co.ke</a></p>
                                <p><a href="mailto:info@example.com">consulting@capelectrotek.co.ke</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="form">
